...
// SimulatorContainerManager implements ContainerManager using an in-memory SimulatorContainerClient.
type SimulatorContainerManager struct {
	client *SimulatorContainerClient
}

// NewSimulatorContainerManager creates a new SimulatorContainerManager with a SimulatorContainerClient.
func NewSimulatorContainerManager() (*SimulatorContainerManager, error) {
	return &SimulatorContainerManager{
		client: NewSimulatorContainerClient(),
	}, nil
}

// ensureImage checks if the specified image is available locally, and attempts to pull it if not.
func (m *SimulatorContainerManager) ensureImage(ctx context.Context, imageName string) error {
...
func (m *SimulatorContainerManager) Create(ctx context.Context, cfg *models.ContainerConfig) (string, error) {
...
func (m *SimulatorContainerManager) Start(ctx context.Context, containerID string) error {
	// start the container
...
func (m *SimulatorContainerManager) StoreLogs(ctx context.Context, containerID string, filePath string) error {
...
func (m *SimulatorContainerManager) List(ctx context.Context, labels map[string]string) ([]*models.ContainerInfo, error) {
...
func (m *SimulatorContainerManager) Get(ctx context.Context, containerID string) (*models.ContainerInfo, error) {
...
func (m *SimulatorContainerManager) Stop(ctx context.Context, containerID string) error {
...
func (m *SimulatorContainerManager) Remove(ctx context.Context, containerID string) error {
